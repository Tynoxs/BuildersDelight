...
public class UtilBlockRendering {
    ...
    public static void register() {
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.OAK_GLASS_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.OAK_GLASS_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.OAK_GLASS_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.OAK_GLASS_8.get(), RenderType.cutout());
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.SPRUCE_GLASS_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.SPRUCE_GLASS_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.SPRUCE_GLASS_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.SPRUCE_GLASS_8.get(), RenderType.cutout());
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.DARK_OAK_GLASS_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.DARK_OAK_GLASS_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.DARK_OAK_GLASS_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.DARK_OAK_GLASS_8.get(), RenderType.cutout());
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.JUNGLE_GLASS_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.JUNGLE_GLASS_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.JUNGLE_GLASS_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.JUNGLE_GLASS_8.get(), RenderType.cutout());
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.BIRCH_GLASS_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.BIRCH_GLASS_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.BIRCH_GLASS_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.BIRCH_GLASS_8.get(), RenderType.cutout());
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.ACACIA_GLASS_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.ACACIA_GLASS_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.ACACIA_GLASS_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.ACACIA_GLASS_8.get(), RenderType.cutout());
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.CRIMSON_GLASS_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.CRIMSON_GLASS_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.CRIMSON_GLASS_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.CRIMSON_GLASS_8.get(), RenderType.cutout());
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.WARPED_GLASS_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.WARPED_GLASS_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.WARPED_GLASS_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.WARPED_GLASS_8.get(), RenderType.cutout());
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.OAK_GLASS_PANE_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.OAK_GLASS_PANE_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.OAK_GLASS_PANE_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.OAK_GLASS_PANE_8.get(), RenderType.cutout());
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.SPRUCE_GLASS_PANE_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.SPRUCE_GLASS_PANE_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.SPRUCE_GLASS_PANE_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.SPRUCE_GLASS_PANE_8.get(), RenderType.cutout());
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.DARK_OAK_GLASS_PANE_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.DARK_OAK_GLASS_PANE_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.DARK_OAK_GLASS_PANE_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.DARK_OAK_GLASS_PANE_8.get(), RenderType.cutout());
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.JUNGLE_GLASS_PANE_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.JUNGLE_GLASS_PANE_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.JUNGLE_GLASS_PANE_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.JUNGLE_GLASS_PANE_8.get(), RenderType.cutout());
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.BIRCH_GLASS_PANE_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.BIRCH_GLASS_PANE_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.BIRCH_GLASS_PANE_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.BIRCH_GLASS_PANE_8.get(), RenderType.cutout());
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.ACACIA_GLASS_PANE_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.ACACIA_GLASS_PANE_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.ACACIA_GLASS_PANE_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.ACACIA_GLASS_PANE_8.get(), RenderType.cutout());
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.CRIMSON_GLASS_PANE_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.CRIMSON_GLASS_PANE_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.CRIMSON_GLASS_PANE_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.CRIMSON_GLASS_PANE_8.get(), RenderType.cutout());
        ...
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.WARPED_GLASS_PANE_5.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.WARPED_GLASS_PANE_6.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.WARPED_GLASS_PANE_7.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(BdBlocks.WARPED_GLASS_PANE_8.get(), RenderType.cutout());
    }
